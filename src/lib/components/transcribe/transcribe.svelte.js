...
// 	navigator.serviceWorker.register("model-loader.worker.js").then(() => location.reload);
// }

// // fetch model file after confirm
// export async function preload(modelFile, printConsole) {
// 	if (
...
// export async function preloadModel(modelFile, printConsole = console.log) {
